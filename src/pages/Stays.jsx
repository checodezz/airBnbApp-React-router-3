            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  golden hues of dusk paint the sky in a breathtaking spectacle.
                  Nestled amidst lush tropical gardens overlooking the azure
                  waters of the Caribbean, this luxurious resort offers a haven
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  nestled in the heart of the majestic mountains. Surrounded by
                  pristine snow-capped peaks and verdant pine forests, this
                  charming lodge offers an idyllic getaway for nature lovers and
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  exquisite amenities, world-class cuisine, and rejuvenating spa
                  treatments.
                </p>
                <p className="card-text">
                  <small className="text-body-secondary">
          ...
          <div className="row">
            ...
            <div className="col-md-8">
              <div className="card-body">
                ...
                <p className="card-text">
                  Embark on a journey of rejuvenation at Tranquil Waters Resort
                  & Spa, where the gentle melody of cascading waterfalls and the
                  fragrance of exotic blooms welcome you to a world of serenity.
                  Tucked away along the tranquil shores of a pristine lake, this
                  luxurious retreat offers a sanctuary for the mind, body, and
                  soul.
                </p>
                <p className="card-text">
                  <small className="text-body-secondary">
